...
```{raw} html
<iframe width="560" height="315" src="https://www.youtube.com/embed/PtVHWKQwVXg" frameborder="0" allowfullscreen></iframe>
```

```{raw} latex
\begin{center}
\textbf{Video:} \url{https://www.youtube.com/watch?v=PtVHWKQwVXg}
\end{center}
```
...
Usa la plataforma [https://web\.learningml\.org/](https://web.learningml.org/) \(se puede utilizar el editor básico [https://basic\.learningml\.org/editor/](https://basic.learningml.org/editor/)\) junto con Scratch [https://scratch\.mit\.edu](https://scratch.mit.edu) para desarrollar la aplicación y resolver el problema\.
