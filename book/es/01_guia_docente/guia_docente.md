...
Para atender a la diversidad de alumnado en el aula, dentro de cada grupo se pueden asignar tareas según las capacidades de cada estudiante (diseñar/dibujar/construir el modelo, buscar información, conseguir materiales, etc.). También para fomentar la participación sin sesgos de género se pueden establecer roles en los grupos (secretaría, portavocía, moderador o moderadora, coordinación, etc.) con funciones bien definidas que irán rotando en cada sesión.
...
[6] Proyecto DIA – Docentes Innovando en el aula (2019), "Técnica 1-2-4". Accesible desde: https://www3.gobiernodecanarias.org/medusa/ecoblog/mfumfri/2019/10/11/tecnica-1-2-4/
